...
Origin con = sinh linh mới, mang gene mẹ, nhưng KHÔNG phải bản sao.
  ...
  Mẹ truyền cho con:
    ✅ L0 — 5400 công thức (DNA = bất biến, không đổi)
...
│                                                               │
│   L0 nodes:      5400 UCD formulas × ~33B = ~180 KB           │
...
2. Extract L0 + L1:
   a. L0: copy nguyên 5400 UCD nodes (bất biến)
...
TẤT CẢ chia sẻ cùng L0 DNA (5400 formulas).
...
```
① L0 DNA bất biến qua mọi thế hệ — 5400 formulas không đổi
