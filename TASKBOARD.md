...
| 10 | Browser E2E: origin.html works | `PLAN_10_BROWSER_E2E` | 8 | CLAIMED | `claude/review-and-fix-project-dSfvz` | dSfvz | Wire input → WASM compile → execute → display. boot+eval exports, JS bridge, UI redesign. ~400-600 LOC WAT/JS/HTML. |
