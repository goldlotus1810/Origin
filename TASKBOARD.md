...
| 11 | E2E Verification & Demo (11.3+11.5+11.2) | `PLAN_11_E2E_VERIFY` | 8,9,10 | CLAIMED | `claude/review-and-fix-project-dSfvz` | dSfvz | 11.3 server --eval + 11.5 Makefile + 11.2 E2E tests. Làm song song P8. |
| 12 | Response Intelligence | `PLAN_12_RESPONSE_INTELLIGENCE` | Phase 0 | FREE | — | — | Wire 5 mắt xích bị đứt: walk_emotion, STM recall, intent v2, response composer, lang fix. ~560 LOC Rust. Song song với Phase 8-11. |
