...
mod tests {
    ...
    fn conflict_reduces_confidence() {
        ...
        assert!(
            ...
            high_conflict.confidence,
            no_conflict.confidence
        );
    }
    ...
    fn describe_conflict() {
        ...
        assert!(
            desc.contains("CONFLICT") || desc.contains("V="),
            "Describe: {}",
            desc
        );
    }
