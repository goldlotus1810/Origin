...
impl FfrPoint {
    ...
    pub fn to_molecule(&self) -> Molecule {
        ...
        let s4 = ((self.shape + 1) & 0xF) as u16;
        let r4 = ((self.relation + 1) & 0xF) as u16;
        let v3 = ((self.valence >> 5) & 0x7) as u16;
        let a3 = ((self.arousal >> 5) & 0x7) as u16;
        let t2 = ((self.time + 1) & 0x3) as u16;
