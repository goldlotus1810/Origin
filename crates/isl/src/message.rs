...
impl ISLMessage {
    ...
    pub fn new(from: ISLAddress, to: ISLAddress, msg_type: MsgType) -> Self {
        Self { from, to, msg_type, payload: [0; 3] }
    }

    /// Tạo với payload.
    pub fn with_payload(from: ISLAddress, to: ISLAddress, msg_type: MsgType, payload: [u8; 3]) -> Self {
        Self { from, to, msg_type, payload }
    }
    ...
    pub fn emergency(from: ISLAddress, code: u8) -> Self {
        Self::with_payload(from, ISLAddress::BROADCAST, MsgType::Emergency, [code, 0, 0])
    }
    ...
    pub fn to_bytes(self) -> [u8; Self::SIZE] {
        ...
        [
            ...
            t[0], t[1], t[2], t[3],
            self.msg_type as u8,
            self.payload[0], self.payload[1], self.payload[2],
        ]
    }
